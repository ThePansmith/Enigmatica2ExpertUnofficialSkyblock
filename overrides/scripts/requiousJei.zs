...
["minecraft:diamond_block", "0", "600000", "Iron", "Gold", "Lapis", "Diamond", "Emerald", "Draconium", "Redstone"],
["minecraft:iron_block", "0", "500000", "Iron", "Copper", "Tin", "Silver", "Lead", "Gold", "Lapis", "Redstone", "Aluminum"],
["thermalfoundation:material", "894", "1000000", "ClathrateRedstone", "ClathrateGlowstone", "ClathrateEnder"],
["minecraft:gold_block", "0", "700000", "Iron", "Copper", "Tin", "Gold", "Lapis", "Diamond", "Emerald", "Coal"],
["nuclearcraft:ingot_block", "3", "1000000", "Thorium", "Boron", "Lithium", "Magnesium"],
["advancedrocketry:moonturf", "0", "1100000", "Prosperity", "ClathrateRedstone", "Iridium", "AstralStarmetal", "Rutile"]
/**/
];
...
add(x, {[<actuallyadditions:item_fertilizer> * 2] : [<forestry:fertilizer_compound>]});
add(x, {[<ic2:crop_res:2> * 2] : [<forestry:fertilizer_compound>]});
add(x, {[<forestry:fertilizer_compound>] : [<forestry:fertilizer_compound>]});
add(x, {[<botania:fertilizer>] : [<forestry:fertilizer_compound>]});
add(x, {[<mysticalagriculture:fertilized_essence> * 3] : [<forestry:fertilizer_compound> * 2]});
add(x, {[<mysticalagriculture:mystical_fertilizer>] : [<forestry:fertilizer_compound> * 2]});
add(x, {[<thermalfoundation:fertilizer>] : [<forestry:fertilizer_compound> * 3]});
add(x, {[<thermalfoundation:fertilizer:1>] : [<forestry:fertilizer_compound> * 4]});
add(x, {[<thermalfoundation:fertilizer:2>] : [<forestry:fertilizer_compound> * 5]});
/**/
// -----------------------------------------------------------------------
// -----------------------------------------------------------------------
x = <assembly:terraplate>;
x.addJEICatalyst(<botania:terraplate>);
x.setJEIDurationSlot(3,1,"duration", SlotVisual.arrowRight());
addInsOuts(x, [[1,0],[0,1],[1,1],[2,1]], [[4,1]]);
...
add(x, {[mana[0], <botania:manaresource>, <botania:manaresource:1>, <botania:manaresource:2>] : [<botania:manaresource:4>]});
/**/