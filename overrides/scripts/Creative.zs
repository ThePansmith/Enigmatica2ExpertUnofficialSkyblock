...
# *======= Variables =======*
	...
	var creativeGasTankFrame = <contenttweaker:tankframe>;
...
# Thermal Creative Tank
	...
	[[<industrialforegoing:black_hole_tank>, <minecraft:milk_bucket>, <forge:bucketfilled>.withTag({FluidName: "blood", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "liquiddna", Amount: 1000}), <thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "bio.ethanol", Amount: 32000}, Level: 0 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Fluid: {FluidName: "bio.ethanol", Amount: 32000}, Level: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "bio.ethanol", Amount: 32000}}), <forge:bucketfilled>.withTag({FluidName: "juice", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "mutagen", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "biomass", Amount: 1000}), <industrialforegoing:black_hole_tank>], 
	...
	[<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "tree_oil", Amount: 32000}, Level: 0 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Fluid: {FluidName: "tree_oil", Amount: 32000}, Level: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "tree_oil", Amount: 32000}}), <contenttweaker:anglesite>, megaDrum, ultCatalyst, <draconicevolution:chaotic_core>, ultCatalyst, megaDrum, <contenttweaker:anglesite>, <thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "ic2uu_matter", Amount: 32000}, Level: 0 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Fluid: {FluidName: "ic2uu_matter", Amount: 32000}, Level: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "ic2uu_matter", Amount: 32000}})], 	[<forge:bucketfilled>.withTag({FluidName: "pyrotheum", Amount: 1000}), ingotUltimate, megaDrum, awakendedCore, ultCatalyst, awakendedCore, megaDrum, ingotUltimate, <forge:bucketfilled>.withTag({FluidName: "ic2pahoehoe_lava", Amount: 1000})], 
	...
	[<industrialforegoing:black_hole_tank>, <forge:bucketfilled>.withTag({FluidName: "ender", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "cryotheum", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "petrotheum", Amount: 1000}), <thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "mana", Amount: 32000}, Level: 0 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Fluid: {FluidName: "mana", Amount: 32000}, Level: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "mana", Amount: 32000}}), <forge:bucketfilled>.withTag({FluidName: "refined_fuel", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "mirion", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "neutron", Amount: 1000}), <industrialforegoing:black_hole_tank>]]); 
# Storage Drawers Unlimited Withdrawel Upgrade
	...
	[<contenttweaker:anglesite>, <aeadditions:storage.component:3>, benitoite, <environmentaltech:solar_cont_6>, <tconstruct:materials:50>, <environmentaltech:solar_cont_6>, benitoite, <aeadditions:storage.component:3>, <contenttweaker:anglesite>], 
...
# Creative Gas Tank 
	...
	[ingotUltimate, blockMirion, <thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "neutron", Amount: 512000}, Level: 3 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Fluid: {FluidName: "neutron", Amount: 512000}, Level: 3as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "neutron", Amount: 512000}, Level: 3 as byte}), <avaritia:resource:4>, ultCatalyst, <avaritia:resource:4>, <thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "mana", Amount: 512000}, Level: 3 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Fluid: {FluidName: "mana", Amount: 512000}, Level: 3as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "mana", Amount: 512000}, Level: 3 as byte}), blockMirion, ingotUltimate], 	[blockStellar, benitoite, gasPad, awakendedCore, <advancedrocketry:liquidtank>, awakendedCore, gasPad, benitoite, blockStellar], 
